...
var slackIncomingWebhookUrl = 'https://hooks.slack.com/services/XXXXXX/XXXXXXXX/XXXXXXXXXXXXXX';

// Include # for public channels, omit it for private channels
var postChannel = "update_ps_XX";

var postIcon = ":mailbox_with_mail:";
var postUser = "Form Response";
var postColor = "#990000";

var messageFallback = "The attachment must be viewed as plain text.";
var messagePretext = "A <" + SpreadsheetApp.getActiveSpreadsheet().getUrl() + "|new issue> has been reported.";
...
var makeFields = function(values) {
  ...
  for (var i = 0; i < columnNames.length; i++) {
    ...
    if(i == 6) {
      fields.push(makeField("Submitted by", val));
    }
  }
